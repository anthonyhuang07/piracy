...
document.body.addEventListener('click', function (event) {
    ...
    function startCountdown() { //the call countdown (7 sec: jumpscare, 15 sec: jumpscare 2, 22 sec: april fools text)
        if (ongoing === 60) {
            ...
            var audio = new Audio('/piracy/assets/audio/jump.mp3');
            audio.play();
            click2 = false;
        } else if (ongoing === 15) {
            ...
            var superLuigi = new Audio('/piracy/assets/audio/superLuigi.mp3');
            superLuigi.play();
        } else if (ongoing === 22) {
    ...
    var audio = new Audio('/piracy/assets/audio/piracy.mp3');
    audio.play();
    // fullscreen requests
